...
async def skill(
    ...
    if bn == '급식' or bn == '생일 급식':
        image_url = 'https://rawcdn.githack.com/syun0914/manl_thumbnail/f19f16a42ec0b6a0ac512119d2b90a3c51d0674b/winter_2022/2022_winter_1_compressed.png'
        ...
        image_url = 'https://rawcdn.githack.com/syun0914/manl_thumbnail/f19f16a42ec0b6a0ac512119d2b90a3c51d0674b/winter_2022/2022_winter_2_compressed.png'
        if not await permission(user_key):
            return tem.basicCard(image_url, '사용 불가', WEAK)
